    ...
    <div className="border border-gray-200 rounded-lg p-3">
      <div className="flex items-center justify-between mb-2">
        ...
        <span className={`text-xs px-2 py-0.5 rounded-full ${
          twin.isActive ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'
        }`}>
  ...
  return (
    <div className="card">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h3 className="font-semibold text-gray-900">Battery Digital Twins</h3>
      </div>
      ...
      {isLoading ? (
        ...
        <p className="text-sm text-gray-400 text-center py-4">No active charging sessions</p>
      ) : (
        <div className="space-y-3">
          {data.twins.map((twin) => (
