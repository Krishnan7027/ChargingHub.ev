      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-primary-900 via-primary-800 to-primary-700 text-white">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-36 pb-40 md:pb-48">
            <div className="max-w-3xl">
              ...
              <p className="animate-in delay-75 mt-6 text-lg md:text-xl text-primary-100 leading-relaxed max-w-2xl">
              ...
              <div className="animate-in delay-150 mt-10 flex flex-col sm:flex-row gap-4">
                <Link
                  href="/map"
                  className="inline-flex items-center justify-center px-9 py-4 bg-white text-primary-700 font-semibold rounded-xl hover:bg-primary-50 transition-all text-lg shadow-lg shadow-black/20 hover:shadow-xl hover:shadow-black/25"
                >
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 -mb-16 z-10">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
              {stats.map((stat, i) => (
                <div
                  key={i}
                  className="animate-in bg-white/10 backdrop-blur-sm rounded-2xl p-5 text-center border border-white/10"
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20">
          <div className="text-center mb-16">
            <h2 className="animate-in text-3xl md:text-4xl font-bold">How It Works</h2>
            <p className="animate-in delay-75 mt-4 text-gray-500 text-lg max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, i) => (
              <div
                key={i}
                className="card-interactive text-center hover:scale-[1.02] hover:-translate-y-1 transition-all duration-300"
              >
                <div
        ...
        <section className="bg-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="animate-in text-3xl md:text-4xl font-bold">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {roles.map((card, i) => (
                <div
                  key={i}
                  className="group relative border border-gray-200 rounded-2xl p-7 transition-all duration-300 hover:shadow-lg hover:border-primary-200 hover:bg-gradient-to-br hover:from-primary-50/50 hover:to-transparent"
                >
                  <div className="flex items-center gap-3 mb-5">
                    <div className="w-10 h-10 rounded-xl bg-primary-100 text-primary-600 flex items-center justify-center group-hover:bg-primary-600 group-hover:text-white transition-colors duration-300">
                      {card.icon}
                    </div>
        ...
        {/* CTA Section */}
        <section className="relative overflow-hidden bg-gradient-to-r from-primary-700 to-primary-900 py-20">
          <svg
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="animate-in delay-150 flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/register"
                className="inline-flex items-center justify-center px-9 py-4 bg-white text-primary-700 font-semibold rounded-xl hover:bg-primary-50 transition-all text-lg shadow-lg"
              >
                Create Free Account
              </Link>
              <Link
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
              ...
              <div className="col-span-2 md:col-span-1">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-lg font-bold text-white">EV Charge Hub</span>
                </div>
